...
var Calendar = /** @class */ (function (_super) {
    ...
    Calendar.prototype.componentWillReceiveProps = function (nextProps) {
        ...
        if ((range && range['endDate'] && !is_same_day_1.default(range['endDate'], range['startDate'])) ||
    ...
    Calendar.prototype.renderMonthAndYear = function (classes) {
        ...
        return (React.createElement("div", { className: classes.monthAndYearWrapper },
            showMonthArrow ? (React.createElement("button", { type: "button", className: classes.prevButton, onClick: function (e) { return _this.changeMonth(-1, e); } },
            ...
            showMonthArrow ? (React.createElement("button", { type: "button", className: classes.nextButton, onClick: function (e) { return _this.changeMonth(1, e); } },
    ...
    Calendar.prototype.renderDays = function (classes) {
        ...
        return days.map(function (data, index) {
            ...
            var isEndEdge = (isStartEdge && range && !range.endDate) || (range && dateUtils_1.checkEndEdge(dayMoment, range));
