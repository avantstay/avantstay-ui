...
var DateRangePicker = /** @class */ (function (_super) {
    ...
    DateRangePicker.prototype.componentWillReceiveProps = function (nextProps) {
        ...
        if (nextProps.startDate || nextProps.endDate) {
            ...
            if (!is_equal_1.default(startDate, oldStartDate) || !is_equal_1.default(endDate, oldEndDate)) {
                this.setRange({
    ...
    DateRangePicker.prototype.render = function () {
        var _this = this;
        var _a = this.props, className = _a.className, format = _a.format, linkedCalendars = _a.linkedCalendars, calendars = _a.calendars, firstDayOfWeek = _a.firstDayOfWeek, minDate = _a.minDate, maxDate = _a.maxDate, classNames = _a.classNames, specialDays = _a.specialDays, lang = _a.lang, offsetPositive = _a.offsetPositive, rangedCalendars = _a.rangedCalendars, disableDaysBeforeToday = _a.disableDaysBeforeToday, shownDate = _a.shownDate, showMonthArrow = _a.showMonthArrow, onClose = _a.onClose, show = _a.show, showApply = _a.showApply, applyLabel = _a.applyLabel, clearButtonLabel = _a.clearButtonLabel, onChange = _a.onChange;
        var _b = this.state, range = _b.range, link = _b.link, portalElement = _b.portalElement;
        var classes = __assign({}, enums_1.defaultClasses, classNames);
        var yearsDiff = get_year_1.default(range.endDate) - get_year_1.default(range.startDate);
        var monthsDiff = get_month_1.default(range.endDate) - get_month_1.default(range.startDate);
        var diff = yearsDiff * 12 + monthsDiff;
        var calendarsCount = Number(calendars) - 1;
        return (react_1.default.createElement("div", { ref: this.positioningRef }, portalElement &&
            react_dom_1.default.createPortal(react_1.default.createElement(Calendar_styles_1.CalendarContainer, { ref: this.calendarContainerRef, className: className, show: show, top: this.offsetTop, left: this.offsetLeft, showApply: showApply },
                react_1.default.createElement("div", { className: classes.dateRange },
                    react_1.default.createElement("div", null, (function () {
                        var _calendars = [];
                    ...
                    showApply && (react_1.default.createElement(Calendar_styles_1.ApplyButton, { onClick: function () {
                            onChange && onChange(range);
                            onClose && onClose();
                        } }, applyLabel)))), portalElement)));
    };
