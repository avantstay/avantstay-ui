...
// SCREEN SIZES
//
exports.XS_SCREEN = '24em'; // 384px
exports.SM_SCREEN = '35.5em'; // 568px
exports.MD_SCREEN = '48em'; // 768px
exports.MD_SCREEN_PLUS_ONE = '769px';
exports.LG_SCREEN = '56em'; // 896px
exports.LG_SCREEN_PLUS_ONE = '897px';
exports.XL_SCREEN_MINUS_ONE = '1023px'; // 1024px
exports.XL_SCREEN = '64em'; // 1024px
exports.XXL_SCREEN = '80em'; // 1280px
exports.XXL_SCREEN_MINUS_ONE = '1279px'; // 1280px
exports.CENTERED_CONTAINER_WIDTH = 1440; // px
