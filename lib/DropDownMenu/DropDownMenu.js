...
var DropDownMenu = /** @class */ (function (_super) {
    ...
    function DropDownMenu(props) {
        ...
        _this.onTrigger = function (event) {
            _this.props.onTrigger && _this.props.onTrigger(event);
        ...
        _this.onSearch = function () {
            ...
            var foundIndex = lodash_findIndex_1.default(_this.props.items, function (it) {
        ...
        _this.id = Math.random().toString(36).substr(2);
        return _this;
    }
