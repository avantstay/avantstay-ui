...
DropDownMenuStories.addDecorator(react_1.default)
    ...
    .add('Stop propagation', function () {
    return (react_3.default.createElement("div", { onClick: function () { return alert("This should't be opened"); } },
        react_3.default.createElement(DropDownMenu_1.default, { items: [
                {
                    label: 'Logout',
                    searchable: 'logout',
                    disabled: false,
                    action: function () { return alert('This should be the one that opens'); },
                },
            ], stopPropagation: true, position: 'right' }, "Menu label")));
});
