...
var FloatingContainer = /** @class */ (function (_super) {
    ...
    FloatingContainer.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { ref: this.positioningRef }, show &&
            portalElement &&
            react_dom_1.default.createPortal(react_1.default.createElement(exports.FloatingContainerRoot, __assign({ className: this.props.className, ref: this.floatingContainerRef }, this.positioning), children), portalElement)));
    };
