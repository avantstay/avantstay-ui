...
var FloatingContainer = /** @class */ (function (_super) {
    ...
    Object.defineProperty(FloatingContainer.prototype, "positioning", {
        get: function () {
            ...
            if (this.props.horizontalAlignment === 'right') {
                return {
                    top: top,
                    right: offset_1.offsetRight(this.positioningRef.current) - offset_1.offsetRight(portalParent),
                };
            }
            return {
                top: top,
    ...
    FloatingContainer.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { ref: this.positioningRef, style: { height: 5, background: 'yellow' } }, show &&
            portalElement &&
            react_dom_1.default.createPortal(react_1.default.createElement(exports.FloatingContainerRoot, __assign({ ref: this.floatingContainerRef }, this.positioning), children), portalElement)));
    };
