...
var FloatingContainer = (function (_super) {
    ...
    function FloatingContainer() {
        ...
        _this.onWindowResize = lodash_debounce_1.default(function () {
            _this.forceUpdate();
        }, _this.props.windowResizeDebounceDelay);
        _this.onClickOut = function (e) {
            e.stopPropagation();
            if (_this.props.show && !isDescendant_1.default(_this.floatingContainerRef.current, e.target)) {
    ...
    FloatingContainer.prototype.UNSAFE_componentWillReceiveProps = function (nextProps) {
