...
function thumbnail(url, options) {
    ...
    var _a = options.fit, fit = _a === void 0 ? 'cover' : _a, _b = options.gravity, gravity = _b === void 0 ? 'entropy' : _b, height = options.height, _c = options.quality, quality = _c === void 0 ? 85 : _c, sharpen = options.sharpen, width = options.width;
    if (url === '')
        return url;
