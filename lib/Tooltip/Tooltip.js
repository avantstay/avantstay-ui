...
function Tooltip(props) {
    ...
    var _s = useElementOffset_1.useElementOffset(wrapperRef.current, scrollableParent), height = _s.height, width = _s.width, left = _s.left, top = _s.top, right = _s.right, bottom = _s.bottom;
