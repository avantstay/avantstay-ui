...
function Tooltip(_a) {
    ...
    var anchorTop = (_o = {},
        _o[VerticalGravity.top] = top - simulatedHeight - Tooltip_styles_1.arrowHeight -
            verticalSpacing,
        _o[VerticalGravity.bottom] = top + height + Tooltip_styles_1.arrowHeight + verticalSpacing,
        _o)[vGravity];
    var anchorLeft = (_p = {},
        _p[HorizontalGravity.center] = left + (width / 2) - simulatedWidth / 2,
        _p[HorizontalGravity.left] = left + (width / 2) - simulatedWidth + 4 *
            Tooltip_styles_1.arrowHeight,
        _p[HorizontalGravity.right] = left + (width / 2) - 4 * Tooltip_styles_1.arrowHeight,
        _p)[hGravity];
