...
exports.TipContainer = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  max-width: ", ";\n  padding: ", ";\n  border-radius: ", ";\n  position: absolute;\n  top: ", "px;\n  left: ", "px;\n  background: ", ";\n  z-index: 999;\n  opacity: 0;\n  animation: ", " 200ms forwards;\n  color: ", ";\n\n  &::after {\n    content: '';\n    position: absolute;\n    ", ": 0;\n    left: ", ";\n    display: block;\n    width: 0;\n    height: 0;\n    border-style: solid;\n    border-width: ", ";\n    border-color: ", ";\n    transform: translateY(", ")\n      translateX(-50%);\n  }\n"], ["\n  max-width: ", ";\n  padding: ", ";\n  border-radius: ", ";\n  position: absolute;\n  top: ", "px;\n  left: ", "px;\n  background: ", ";\n  z-index: 999;\n  opacity: 0;\n  animation: ", " 200ms forwards;\n  color: ", ";\n\n  &::after {\n    content: '';\n    position: absolute;\n    ", ": 0;\n    left: ",
    ...
    return p.vGravity === Tooltip_1.VerticalGravity.top
        ? exports.arrowHeight + "px " + exports.arrowHeight + "px 0 " + exports.arrowHeight + "px"
        : "0 " + exports.arrowHeight + "px " + exports.arrowHeight + "px " + exports.arrowHeight + "px";
}, function (p) {
    return p.vGravity === Tooltip_1.VerticalGravity.top
        ? p.backgroundColor + " transparent transparent transparent"
        : "transparent transparent " + p.backgroundColor + " transparent";
}, function (p) { return (p.vGravity === Tooltip_1.VerticalGravity.top ? 'calc(100% - 1px)' : 'calc(-100% + 1px)'); });
