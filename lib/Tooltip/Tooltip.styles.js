...
exports.TipContainer = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  max-width: ", ";\n  padding: ", "; \n  border-radius: ", "; \n  position: absolute;\n  top: ", "px;\n  left: ", "px;\n  background: ", ";\n  z-index: 999;\n  transform: \n    translateY(", ") \n    translateX(", ");  \n  opacity: 0;\n  animation: ", " 200ms forwards;\n  color: ", ";\n  \n  &::after {\n    content: '';\n    position: absolute;\n    ", ": 0;\n    left: ", ";\n    display: block;\n    width: 0;\n    height: 0;\n    border-style: solid;\n    border-width: ", ";\n    border-color: ", ";\n    transform: translateY(", ") translateX(-50%);\n  }\n"], ["\n  max-width: ", ";\n  padding: ", "; \n  border-radius: ", "; \n  position: absolute;\n  top: ", "px;\n  left: ", "px;\n  background: ", ";\n  z-index: 999;\n  transform: \n    translateY(",
    ...
    ";\n    display: block;\n    width: 0;\n    height: 0;\n    border-style: solid;\n    border-width: ",
    ";\n    border-color: ",
    ";\n    transform: translateY(", ") translateX(-50%);\n  }\n"])), function (p) { return typeof p.maxWidth === 'number' ? p.maxWidth + "px" : p.maxWidth; }, function (p) { return typeof p.padding === 'number' ? p.padding + "px" : p.padding; }, function (p) { return typeof p.borderRadius === 'number' ? p.borderRadius + "px" : p.borderRadius; }, function (p) { return p.top; }, function (p) { return p.left; }, function (p) { return p.backgroundColor; }, function (p) { return p.vGravity === Tooltip_1.VerticalGravity.top
    ? "calc(-100% - " + (exports.arrowHeight + p.vSpacing) + "px)"
    : "calc(" + (exports.arrowHeight + p.vSpacing) + "px)"; }, function (p) { return ({
    center: '-50%',
    left: "calc(-100% + " + exports.arrowHeight * 4 + "px)",
    right: "-" + exports.arrowHeight * 4 + "px"
}[p.hGravity]); }, appearIn, function (p) { return p.textColor; }, function (p) { return p.vGravity === Tooltip_1.VerticalGravity.top ? 'bottom' : 'top'; }, function (p) { return ({
    center: '50%',
