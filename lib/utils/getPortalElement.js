...
var _portalElements = [];
function createPortalElementAt(parentElement) {
    var portalElement = document.createElement('div');
    parentElement.appendChild(portalElement);
    return portalElement;
}
exports.createPortalElementAt = createPortalElementAt;
...
function getScrollableParent(node) {
    ...
    var _a = window.getComputedStyle(node), overflow = _a.overflow, overflowX = _a.overflowX, overflowY = _a.overflowY, position = _a.position;
    if (position === 'static') {
