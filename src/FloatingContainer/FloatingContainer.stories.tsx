...
Stories.add('Default usage', () =>
  (<div>
      ...
      <div style={{
        width: '50%', /*height: '350px', overflow: 'hidden',*/
        position: 'relative',
        marginLeft: 50,
      }}>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. In fermentum
          quis turpis nec dictum. Ut finibus ante at pretium
          mollis. Quisque mattis finibus congue. Praesent vitae massa vitae
          tortor consectetur luctus. Curabitur dapibus nunc eget
          ipsum tempor, at hendrerit tellus ultrices. Etiam ac rhoncus elit, ut
          iaculis turpis. Suspendisse at bibendum mi. Aliquam
          semper eros quis quam tempor, ac blandit ligula volutpat.
        </p>
        ...
        <p>
          ...
          quis arcu sapien. Nulla finibus justo ut tortor aliquet, a aliquet
          massa venenatis. Praesent augue ipsum, ultrices vitae
        ...
        <div>
          <p>
            ...
            Accusantium nulla officia ratione. Aspernatur necessitatibus
            optio possimus quam sequi suscipit tempora. Aliquid beatae, culpa
            est expedita molestiae necessitatibus praesentium sint
            veniam?
          </p>
...
const ClickToShow = () => {
  ...
  return <div>
    <button type="button" onClick={() => setShow(!show)}>Show container</button>
    <FloatingContainer show={show}>
      ...
      >
        ...
        iure
        soluta. Aliquam corporis ducimus eius fugiat impedit labore maxime
        molestiae nam nesciunt nihil officiis optio porro quis, velit vitae
        voluptates.
      </div>
